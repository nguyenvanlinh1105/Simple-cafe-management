	...
	<form  id="formSubmit" method="get">
				    ...
				    <div class="row align-items-center">
				        <div class="col-lg-8">
				            <div class="row align-items-center mb-3">
				                <div class="col-md-6">
				                    <h2 class="mb-0">Chọn bàn cần thanh toán:</h6>
				                </div>
            ...
            <div class="row">
                <div class="col col-md-12">
                        ...
                        <c:forEach var="item" items="${sanPham}">
                            <tr>
                               <td><input type="checkbox" id="" value="${item.maHoaDon_ID }-${item.maChiTiet_ID}"></td>
                                <td>
                                    <img src="template/web/images/cart.jpg" class="hinhdaidien">
                                </td>
                                <td>${item.maBan_ID}</td>
                                <td>${item.tenBan}</td>
                    ...
                    <a href='<c:url value="/web-checkout?maBan_ID=2"/>' class="btn btn-primary btn-md mt-4 mb-4 "><i
